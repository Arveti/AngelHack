...
import com.sun.media.jai.codec.SeekableStream;
    ...
    */
   public class MatchFash extends JFrame
     {
...
System.setProperty("com.sun.media.jai.disableMediaLib", "true");
     ...
     public MatchFash(File reference) throws IOException
       ...
       for (int o = 0; o < others.length; o++)
         ...
         JLabel ldist = new JLabel("<html>" + others[o].getName() + "<br>"
             + String.format("% 10.3f", distances[o]) + "</html>");
         ldist.setFont(new Font(Font.MONOSPACED, Font.PLAIN, 17));
    ...
    */
    private File[] getOtherImageFiles(File reference)
      ...
      File[] others = dir.listFiles(new FilterJPG());
      return others;
      }
    ...
    */
    public static void main(String[] args) throws IOException
      ...
      fc.setFileFilter(new FilterJPG());
